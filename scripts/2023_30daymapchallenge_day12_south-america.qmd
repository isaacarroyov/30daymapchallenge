...
<h1>#30DayMapChallenge Day 12: <span style='text-decoration:line-through 5px;'>South</span> Latin America (Taylor's Version)</h1>

<p>Hello <span style="font-family:'Abril Fatface', serif;">THE ERAS TOUR</span>! Welcome to your <span style='text-decoration:line-through 2px;'>South</span> Latin America venues! (<span style='color:#EAA9C2;'>2023</span>)</p>
<p id="nota_subtitle">
...
# = = FINAL DATAVIS = = #
mapa = (latam + points_eras_tour).project(
        type = "equalEarth"
    ).properties(
